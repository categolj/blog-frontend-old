...
@Component
public class PrerenderClientImpl implements PrerenderClient {
	...
	public PrerenderClientImpl(WebClient.Builder builder, Prerender prerender) {
	...
	class PrerenderAsyncCacheLoader implements AsyncCacheLoader<String, String> {
		...
		public CompletableFuture<String> asyncLoad(@NonNull String key, @NonNull Executor __) {
			return PrerenderClientImpl.this.prerender(HttpMethod.GET, key).toFuture();
		}
	}
}
